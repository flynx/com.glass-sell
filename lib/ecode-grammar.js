...
// 			//
// 			// If a required field can not be extracted (ecode too short)
// 			// an error is returned.
// 			required: <bool>,
//
// 			// An explicit match is required (default: false)
// 			//
// 			// If this is true then the field must match at least one
// 			// pattern explicitly, if no match is found an error is 
// 			// returned.
// 			//
// 			// NOTE: setting this to true on a non required field implicitly
// 			//		makes it required, even if it is set to required: false.
// 			match_required: <bool>,
//
...
//
// 		When this error occurs the parser stops and returns a result with
// 		a set .error field
//
// 	2) a given ecode part did not match any pattern but a match was 
// 		required by the grammar.
//
// 		As with #1, the parser stops and returns an error object.
//
// 	3) field not defined or defined incorrectly.
// 		This is a non critical error, such fields are simple returned as-is
// 		in one of two forms:
